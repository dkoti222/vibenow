...
import Assitanace from './Assitanace';

const Home = ({navigation}) => {
  
  const context = React.useContext(GlobalContext);
  console.log(context.profileMatch,'fgfgfgfghgfgfg')
  ...
  const profileMatching = async () => {
    ...
    console.log(res,'new  kkklsankdfnjndajkndnafnsa')
  ...
  return (
   ...
   {
    context.modeId === 3  ? (<Assitanace  navigation={navigation}/>):(<View>
